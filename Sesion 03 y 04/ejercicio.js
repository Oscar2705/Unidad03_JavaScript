...
// La informacion debe ser guardada como objeto dentro del array users asignadole un id unico a cada registro.
 let users={
    name:"", apellido:"", edad:"", profesion:""
 }
function ingresar(){
    let informacion= prompt("Ingrese la informacion del usuario")
    let array = informacion.split(" ")
    console.log(array)
    array.push(`20`)
    console.log(array)
    // users.push(users.name[0], users.apellido[1])
    // console.log(users)
}
